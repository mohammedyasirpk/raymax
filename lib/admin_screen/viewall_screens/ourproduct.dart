...
class AddOurProductAdmin extends StatefulWidget {
  const AddOurProductAdmin({Key? key,  this.productData}) : super(key: key);


  final ProductModel? productData;

  @override
  State<AddOurProductAdmin> createState() => _AddOurProductAdminState();
}
...
class _AddOurProductAdminState extends State<AddOurProductAdmin> {
  ...
  void initState() {
    ...
    productTypeList = widget.productData?.modelList?? [];
      productTypeTextController = TextEditingController();
   productNameTextController = TextEditingController(text: widget.productData?.productName?? "");
   warrentyTextController = TextEditingController(text:  '${ widget.productData?.warranty?? ""}');
   additionalWarrentyTextController = TextEditingController(text:  '${ widget.productData?.additionalWarranty?? ""}');
                    ...
                    children: [
                                    ...
                                    // ignore: unnecessary_null_comparison
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image:isimageLoading == false ? (image != null &&
                                                  image!.isNotEmpty && widget.productData != null )
                                              ? DecorationImage(
                                              fit: BoxFit.cover,
                                              ...
                                              : const DecorationImage(
                                                fit: BoxFit.cover,
                                                  image: AssetImage(
                                                      "images/5357829_prev.jpg")):null,
                                          color: Colors.grey[200],
                                          borderRadius: BorderRadius.circular(12),
                                          
                                        ),child: isimageLoading == true? const Center(child: CircularProgressIndicator(),):null,
                                        width: 100,
                                        height: 100,
                                      ),
                                    const Positioned(
                      ...
                      TextFormField(
                        ...
                        decoration: textFieldDecoration(
                            suffix: TextButton(
                                onPressed: () {
                                  productTypeList.add(productTypeTextController
                                      .text
                                      .toLowerCase());
                      ...
                      Expanded(
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            if (image == null) {
                              showsnackbar(
                                  "Please Select Product Image", context,SnackbarCondition.warning);
                              return;
                            }

                            if (productTypeList.isEmpty) {
                              showsnackbar(
                                  "Add minimum one Product Type", context,SnackbarCondition.warning);
                              return;
                            }
                            ...
                            if (_formKey.currentState?.validate() == true) {
                              ...
                              showsnackbar(
                                  widget.productData == null ? "Product Added Successfully" : "Product Edited Successfully", context,SnackbarCondition.success);
                              Navigator.pop(context, false);
                            } else {
                              showsnackbar("All fields Are Required", context,SnackbarCondition.warning);
                            }
                          },
                          child:  Text(
