...
import 'firebaseMessage/send_notification.dart';
...
class FirebaseAuthentication {
  ...
  Future<void> login(
    ...
    try {
     ...
     final userDeatails = await _auth.signInWithEmailAndPassword(
          email: email.replaceAll(' ', ''),
          password: password.replaceAll(' ', ''));
                String Fcmtoken = await initNotification();
              
              
      await _firestore.collection('users').doc(userDeatails.user!.uid).update(
        {
          "notification": Fcmtoken,
        },
      );
