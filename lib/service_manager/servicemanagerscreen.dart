...
import '../customerr_screen/customer_screen.dart';
import '../repository/topsnackbar.dart';
import 'complaint_service_container.dart';

class ServiceManagerDashboard extends StatefulWidget {
  const ServiceManagerDashboard(
      {Key? key, this.complaintModel, required this.userdata})
      : super(key: key);
  ...
  @override
  State<ServiceManagerDashboard> createState() =>
      _ServiceManagerDashboardState();
}

class _ServiceManagerDashboardState extends State<ServiceManagerDashboard> {
  int selectedValue = 0;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(5.0).copyWith(left: 20, bottom: 0),
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  ViewAllScreen(userData: widget.userdata),
                            ));
                      },
                      child: Text(
                        'View All',
              ...
              builder: (context, snapshot) {
                ...
                for (QueryDocumentSnapshot<Map<String, dynamic>> element
                  ...
                  ComplaintModel xcomplaints = ComplaintModel.fromMap(
                      element.data(), element.id,element.data()[productIdKeyFirestore]);
